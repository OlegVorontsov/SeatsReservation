...
namespace SeatsReservation.Infrastructure.Postgres.Migrations
{
    ...
    [Migration("20250702121449_Initial")]
            ...
            modelBuilder.Entity("SeatsReservation.Domain.Entities.Reservations.ReservationSeat", b =>
                {
                    ...
                    b.HasIndex("SeatId")
                        .HasDatabaseName("ix_reservation_seats_seat_id");
            ...
            modelBuilder.Entity("SeatsReservation.Domain.Entities.Venues.Venue", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("VenueName", "SeatsReservation.Domain.Entities.Venues.Venue.VenueName#VenueName", b1 =>
                        {
                            b1.IsRequired();
